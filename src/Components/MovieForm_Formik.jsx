...
const MovieForm_Formik = ({movieList,setMovieList }) => {
   const  [theme, setTheme] = useContext(ThemeContext)
    ...
    const formSchema = Yup.object().shape({
        ...
        summary: Yup.string().min(10, "Put greater summary").max(100, "Put shorter summary").required("Feilds are mandatory"),
    ...
    return (
        <>
            <Box>
                ...
                <div> <TextField value={formik.values.summary} id="standard-multiline-static"
                    label="Movie summary"
                    name="summary"
